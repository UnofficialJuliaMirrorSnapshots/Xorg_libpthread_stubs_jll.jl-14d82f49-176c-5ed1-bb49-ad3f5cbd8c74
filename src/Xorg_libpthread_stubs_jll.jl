module Xorg_libpthread_stubs_jll
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("14d82f49-176c-5ed1-bb49-ad3f5cbd8c74"))
...
if best_platform === nothing
    @debug("Unable to load Xorg_libpthread_stubs; unsupported platform $(triplet(platform_key_abi()))")
else
